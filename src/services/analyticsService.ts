// ---------------------------------------------------------------------------
// ANALYTICS SERVICE — lightweight aggregates for the dashboard. Uses head-count
// queries (no rows transferred) for totals, and a small bounded fetch of recent
// bills for revenue + the activity feed.
// ---------------------------------------------------------------------------
