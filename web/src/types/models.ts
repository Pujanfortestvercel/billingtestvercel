...
// type each field is. They will match the database tables we build in Phase 2,
// one-to-one. Defining them now gives you auto-complete and catches mistakes
// like a typo'd field name BEFORE the app ever runs.
//
